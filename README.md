...
Este repositório contém os conjuntos de dados, scripts de análise preditiva/inferencial e a documentação técnica do projeto de extensão universitária desenvolvido no Restaurante KI-delicia, localizado em Camaçari/BA. 
